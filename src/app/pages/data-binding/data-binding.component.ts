...
export class DataBindingComponent {
  ...
  public changeName (inputName: HTMLInputElement, inputSurname: HTMLInputElement, inputAge: HTMLInputElement, inputJob: HTMLInputElement) {
    this.person.name = inputName.value;
    this.person.surname = inputSurname.value;
    this.person.age = Number(inputAge.value);
    this.person.job = inputJob.value;
  }
}
